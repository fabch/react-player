    ...
    value: function load(url) {
      ...
      if (this.shouldUseHLS(url)) {
        (0, _utils.getSDK)(HLS_SDK_URL.replace('VERSION', hlsVersion), HLS_GLOBAL).then(function (Hls) {
          ...
          _this2.hls.on(Hls.Events.LEVEL_SWITCHING, function () {
            var _this2$props;

            (_this2$props = _this2.props).onLevelSwitching.apply(_this2$props, arguments);
          });

          _this2.hls.on(Hls.Events.LEVEL_SWITCHED, function () {
            var _this2$props2;

            (_this2$props2 = _this2.props).onLevelSwitched.apply(_this2$props2, arguments);
          });

          _this2.hls.on(Hls.Events.LEVEL_LOADING, function () {
            var _this2$props3;

            (_this2$props3 = _this2.props).onLevelLoading.apply(_this2$props3, arguments);
          });

          _this2.hls.on(Hls.Events.LEVEL_LOADED, function () {
            var _this2$props4;

            (_this2$props4 = _this2.props).onLevelLoaded.apply(_this2$props4, arguments);
          });

          _this2.hls.on(Hls.Events.LEVEL_UPDATED, function () {
            var _this2$props5;

            (_this2$props5 = _this2.props).onLevelUpdated.apply(_this2$props5, arguments);
          });
